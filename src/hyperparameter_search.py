"""
Grid search over RPER hyperparameters on the Random split.
Validates that RPER achieves F1 > baseline (84.50) and selects
optimal (alpha, tau_lo, tau_hi, opera_override_margin).
"""
